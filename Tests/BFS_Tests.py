...
class TestProgram(unittest.TestCase):
    ...
    def test_case_1(self):
        self.assertEqual(Searching.breadthFirstSearch(test1, []), ["A", "B", "C", "D"])

    def test_case_2(self):
        self.assertEqual(Searching.breadthFirstSearch(test2, []), ["A", "B", "C", "D", "E", "F"])

    def test_case_3(self):
        self.assertEqual(Searching.breadthFirstSearch(test3, []), ["A", "B", "C", "D", "E", "F"])

    def test_case_4(self):
        self.assertEqual(Searching.breadthFirstSearch(test4, []), ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K"])

    def test_case_5(self):
        self.assertEqual(Searching.breadthFirstSearch(test5, []),
